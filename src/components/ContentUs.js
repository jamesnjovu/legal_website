...
const ContentUs = () => {
    ...
    const handleSubmit = (e) => {
        ...
        download.href = `mailto:${inputs.email}?subject=WebSite%20Contact%20Us&body=${inputs.body}`;
    ...
    return (
        <section id="#contact_us" className="bg-gradient-to-r from-gray-600 via-gray-800 to-gray-900 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 ">
