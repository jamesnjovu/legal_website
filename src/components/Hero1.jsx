...
import { Bars3Icon, LifebuoyIcon, NewspaperIcon, PhoneIcon, XMarkIcon } from './icons'
    ...
    return (
        <div className="bg-white">
            ...
            <main>
                ...
                {/* Newsletter Section */}
                <section
                    className="mx-auto max-w-md py-24 px-6 sm:max-w-3xl lg:flex lg:max-w-7xl lg:items-center lg:py-32 lg:px-8"
            ...
            <footer className="bg-blue-gray-50" aria-labelledby="footer-heading">
                ...
                <div className="mx-auto max-w-md py-12 px-6 sm:max-w-7xl lg:py-16 lg:px-8">
